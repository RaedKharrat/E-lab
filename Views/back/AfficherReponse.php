...
$listeProduits=$RepServ->afficherReponse();
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <a href="../front/AfficherReponse.php" class="btn btn-danger"   >  <i class="material-icons">loop</i> </a>
...
<section class="content">
    <div class="container-fluid">
       ...
       <!-- <div class="row clearfix">
        ...
        <div class="row clearfix">
            <!-- Task Info -->
            <div class="col-xs-20 col-sm-20 col-md-10 col-lg-10">
                <div class="card">
                    <div class="header">
                        <h2>Les Reponses</h2>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                foreach($listeProduits as $row){
                                    ...
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo $row['idReponse'] ?></th>
                                  
                                        <td><?php echo $row['description'] ?> </td>
                                        <td><?php echo $row['dateTraitement'] ?></td>
                                        <td>0<?php echo $row['rating'] ?>/5</td>
                                        <td><?php echo $row['reclamation_id'] ?></td>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" type="submit"><i class="material-icons">auto_delete</i> </button>
                                        ...
                                        <td>
                                            <form method="POST" action="../../Controllers/SendMail.php">
                                                <button class="btn btn-cyan" type="submit"><i class="">mail</i> </button>
                                                <input type="hidden" value="<?PHP echo $row['idReponse']; ?>" name="idReponse">
                                                <input type="hidden" value="<?PHP echo $row['description']; ?>" name="description">
