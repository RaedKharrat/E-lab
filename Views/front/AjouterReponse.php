    ...
    <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Accueil <i class="fa fa-chevron-right"></i></a></span> <span>Reponse<i class="fa fa-chevron-right"></i></span></p>
                <h1 class="mb-0 bread">Reponse :</h1>
            </div>
        </div>
    </div>
</section>
...
<section class="ftco-section">
    <div class="container">
        ...
        <div class="row">
            ...
            <form  onsubmit="return validateForm()" name="myForm" method="POST" action="../../Controllers/front/AjouterReponseC.php" >
                <div class="row align-items-stretch mb-5">
                    <div >
                        <div class="form-group">
                            <textarea class="form-control"  id="description" name="description"  type="text" placeholder="Taper votre reponse .."/></textarea>
